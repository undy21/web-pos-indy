...
const INITIAL_USERS = [
  ...
  { id: 'u3', username: 'kasir1', name: 'Siti (Kasir Jakarta)', role: 'CASHIER', branchId: 'b1', active: true, password: 'kasir1' },
  { id: 'u4', username: 'kasir2', name: 'Andi (Kasir Bandung)', role: 'CASHIER', branchId: 'b2', active: true, password: 'kasir2' },
];
